...
PLUGINVERSION = 2
plugin = core.Plugin()
ABOUT_STRING = "OctoBot-PTB based on commit <code>" + subprocess.check_output('git log -n 1 --pretty="%h"', shell=True).decode('utf-8') + "</code>"
...
ABOUT_STRING += '<a href="github.com/octonezd/octobot">GitHub page</a>\n'
