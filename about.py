...
ABOUT_STRING += subprocess.check_output('git --git-dir octeon/.git log -n 1 --pretty=" Octeon-Core based on commit <code>%h</code>"', shell=True).decode('utf-8')[1:]
...
ABOUT_STRING += '<a href="github.com/octonezd/octeon">GitHub page</a>\n'
